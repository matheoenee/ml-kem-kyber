...
from kyber.sampling import SampleNTT, SamplePolyCBD
from kyber.cryptographic import PRF, G
from kyber.ntt import NTT, inv_NTT, MultiplyNTTs
from kyber.polynomials import AddPolynomials, SubPolynomials
from kyber.conversion import ByteDecode, ByteEncode, Compress, Decompress

from kyber.params import *
from . import q, n

def PKE_KeyGen(d: bytes, params: KYBERParams) -> list[bytes]:
    """
    ...
    Inputs:
        ...
        params (KYBERParams): An object containing Kyber parameter values, including:
...
def PKE_Encrypt(ek_pke: bytes, m: bytes, r: bytes, params: KYBERParams) -> bytes:
    """
...
def PKE_Decrypt(dk_pke: bytes, c: bytes, params: KYBERParams) -> bytes:
    """
